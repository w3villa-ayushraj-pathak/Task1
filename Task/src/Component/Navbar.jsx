...
const Navbar = () => {
  ...
  return (
    <>
      <div className="w-full text-white shadow-md bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMfLY1q-5vXFVWKKvOx_6S_UgRsKUrWM6wPpWKAG2lDA&s=10')] bg-cover bg-center">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center justify-center gap-4 lg:gap-8 text-sm lg:text-base font-medium">
            <a href="" className="flex items-center gap-1 hover:text-yellow-400 transition duration-300">
            ...
            <a href="" className="flex items-center gap-1 hover:text-yellow-400 transition duration-300">
              Services <FontAwesomeIcon icon={faAngleDown} className="text-xs" />
            </a>
            <a href="" className="flex items-center gap-1 hover:text-yellow-400 transition duration-300">
              Project <FontAwesomeIcon icon={faAngleDown} className="text-xs" />
            </a>
            <a href="" className="flex items-center gap-1 hover:text-yellow-400 transition duration-300">
              Blog <FontAwesomeIcon icon={faAngleDown} className="text-xs" />
            </a>
            <a href="" className="flex items-center gap-1 hover:text-yellow-400 transition duration-300">
              Contact <FontAwesomeIcon icon={faAngleDown} className="text-xs" />
            </a>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            {!isOpen && (
              <button
                ...
                className="text-3xl font-bold text-right hover:text-yellow-400 transition duration-300 md:hidden"
              >
                ☰
              </button>
            )}
